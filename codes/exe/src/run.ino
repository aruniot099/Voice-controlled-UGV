...
void loop()
{
    ...
    command = checkClient ();
         ...
         if (command == "forward" || command == "munduki" || command == "aage")  forwardMotor();
    else if (command == "reverse" || command == "venaka"  || command == "piche") reverseMotor();
    else if (command == "left"    || command == "yedama"  || command == "die")   leftMotor();    
    else if (command == "right"   || command == "kudi"    || command == "bhai")  rightMotor();     
    else if (command == "stop"    || command == "aagu"    || command == "ruk")   stopMotor();     
